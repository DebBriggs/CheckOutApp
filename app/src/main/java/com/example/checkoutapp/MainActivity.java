...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        payButton = findViewById(R.id.pay); //initialize pay button
    ...
    private void pay() {
        ...
        new RavePayManager(this) // Create a new instance of the RavePayManager object. This is from the SDK and it is what handles the payments for us.
                ...
                .setPublicKey("FLWPUBK-ce7fca840ee1621ebf7a3cc83052d9ad-X") // This is the public kay of your RAve account. Get it from your Rave dashboard and put it in here. I'm leaving this one for you to do
                .setEncryptionKey("b6e81f18697b85ebfeded5c4") // Also get the encryption key from your rave dashboard
